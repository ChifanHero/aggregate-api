...
public class ElasticConfigs {
    ...
    static {
        ...
        HOSTS = ConfigHelper.getPropertyAsList(Host.class, "HOSTS", Collections.singletonList(new Host("ec2-54-69-87-122.us-west-2.compute.amazonaws.com", 9200)), (String str) -> {
